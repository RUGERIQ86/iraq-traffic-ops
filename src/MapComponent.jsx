...
const getUnitIcon = (type, isMe = false, session = null) => {
  // FORCE RED FOR RUGER@1.COM OR IF IT'S ME
  const symbolColor = (isMe || (session?.user?.email === 'ruger@1.com' && isMe)) ? '#ff0000' : '#00ff00';
  
  // UNIFIED RED COLOR FOR RADIATION WAVES FOR EVERYONE
  ...
  const radiationWaves = `
    <div class="radiation-wave-integrated" style="border-color: ${waveColor}"></div>
    <div class="radiation-wave-integrated" style="border-color: ${waveColor}"></div>
    <div class="radiation-wave-integrated" style="border-color: ${waveColor}"></div>
  `;
  ...
  switch (type) {
    case 'driver':
      iconContent = `
        <div class="unit-icon-container">
          ${radiationWaves}
          <div class="unit-symbol" style="color: ${symbolColor};">
    ...
    default: // infantry
      iconContent = `
        <div class="unit-icon-container">
          ${radiationWaves}
          <div class="radiation-core" style="background: ${symbolColor}"></div>
        </div>`;
  }

  return L.divIcon({
    className: 'custom-unit-marker-v2',
    html: iconContent,
    iconSize: [40, 40],
    iconAnchor: [20, 20],
    popupAnchor: [0, -20],
    ...
    <div className="map-wrapper">
      ...
      <div className="hud-overlay">
          <TopHUD
            ...
            setTrackingUnitId={setTrackingUnitId}
          ...
          <StatusBar statusMsg={statusMsg} lastSyncTime={lastSyncTime} />
